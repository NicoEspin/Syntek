    ...
    <main className="overflow-hidden bg-[#0a0a0a] text-white">
      <section className="relative px-4 pb-24 pt-32 md:px-5 md:pt-36 lg:px-10 xl:px-24">
        <div aria-hidden className="pointer-events-none absolute inset-0">
          <div className="absolute inset-x-0 top-0 h-[38rem] bg-[radial-gradient(circle_at_16%_18%,rgba(161,226,51,0.16),transparent_34%),radial-gradient(circle_at_82%_24%,rgba(255,255,255,0.08),transparent_24%),linear-gradient(180deg,rgba(8,8,8,0.16),rgba(10,10,10,0.96))]" />
          <div className="absolute left-[9%] top-28 h-56 w-56 rounded-full bg-primary1/10 blur-[120px]" />
              ...
              <div className="mt-5 space-y-4">
                {t.raw("signals").map((signal) => (
                  <div key={signal} className="flex gap-3">
                    ...
                    <p className="text-sm leading-relaxed text-white/62">{signal}</p>
                  </div>
                ))}
              </div>
