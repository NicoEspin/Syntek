...
const CordobaCta = () => {
  const t = useTranslations("Cordoba.cta");
  const waHref = getWhatsAppUrl(useTranslations("Cordoba")("waMessage"));

  return (
    <section aria-labelledby="cordoba-cta-heading" className="relative overflow-hidden px-4 py-24">
      <div
        aria-hidden
